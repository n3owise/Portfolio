  ...
  return (
    <section id="archive" ref={containerRef} className="py-12 md:py-16 px-4 sm:px-6 md:px-12 border-b-4 border-ink bg-paper">
      <div className="mb-12 flex justify-between items-end border-b-2 border-ink pb-4">
        <h2 className="text-4xl md:text-6xl font-serif uppercase tracking-tight font-black">Project Archive</h2>
        <span className="text-sm uppercase tracking-widest font-bold">Complete List (2)</span>
      </div>
          ...
          >
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <button
                ...
                className="px-4 py-2 text-xs uppercase tracking-widest font-bold border-2 border-ink hover:bg-ink hover:text-paper transition-colors"
              >
                Process Snapshot
              </button>
          ...
          <div className="w-full max-w-3xl bg-paper border-2 border-ink shadow-2xl">
            <div className="flex items-center justify-between border-b-2 border-ink px-4 md:px-6 py-3">
              ...
              <button
                ...
                className="text-xs uppercase tracking-widest font-bold border-2 border-ink px-3 py-1 hover:bg-ink hover:text-paper transition-colors"
              >
                Close
              </button>
            </div>
